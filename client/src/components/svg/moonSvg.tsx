...
const MoonSvg = (props: MoonSvgProps) => {
    return (
        <svg viewBox="-5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns-xlink="http://www.w3.org/1999/xlink" xmlns-sketch="http://www.bohemiancoding.com/sketch/ns" className={props.className}>
            ...
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch-type="MSPage">
                <g id="Icon-Set-Filled" sketch-type="MSLayerGroup" transform="translate(-575.000000, -829.000000)" fill="#fff">
